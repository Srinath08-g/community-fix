...
import { updateTicketStatus, addComment } from '../../services/ticketService';
...
const OfficialTicketDetailScreen = ({ route, navigation }) => {
  ...
  useEffect(() => {
    const unsubscribeTicket = onSnapshot(doc(db, 'tickets', ticketId), (docSnap) => {
      if (docSnap.exists()) {
        ...
        ListHeaderComponent={
          <View style={styles.detailsContainer}>
            ...
            <View style={styles.statusSection}>
              ...
              <TouchableOpacity style={styles.updateButton} onPress={handleStatusUpdate} disabled={updating}>
...
const styles = StyleSheet.create({
  ...
  statusSectionTitle: { fontSize: 15, fontWeight: 'bold', color: COLORS.dark, marginBottom: 8 },
  pickerContainer: {
...
export default OfficialTicketDetailScreen;
